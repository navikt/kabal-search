...
class BehandlingerSearchCriteriaMapper(
    ...
    ): FerdigstilteOppgaverForAssignedSaksbehandlerSearchCriteria {
        val permissions = resolvePermissions()
        return FerdigstilteOppgaverForAssignedSaksbehandlerSearchCriteria(
    ...
    ): ReturnerteROLOppgaverForAssignedRolSearchCriteria {
        val permissions = resolvePermissions()
        return ReturnerteROLOppgaverForAssignedRolSearchCriteria(
            typer = queryParams.typer.map { Type.of(it) },
            ytelser = queryParams.ytelser.map { Ytelse.of(it) },
            hjemler = queryParams.hjemler.map { Hjemmel.of(it) },
            navIdent = navIdent,
    ...
    ): UferdigeOppgaverForSaksbehandlerOrMedunderskriverOrRolSearchCriteria {
        val permissions = resolvePermissions()
        return UferdigeOppgaverForSaksbehandlerOrMedunderskriverOrRolSearchCriteria(
            typer = queryParams.typer.map { Type.of(it) },
            ytelser = queryParams.ytelser.map { Ytelse.of(it) },
            hjemler = queryParams.hjemler.map { Hjemmel.of(it) },
            navIdent = navIdent,
    ...
    ): OppgaverPaaVentForSaksbehandlerOrMedunderskriverSearchCriteria {
        val permissions = resolvePermissions()
        return OppgaverPaaVentForSaksbehandlerOrMedunderskriverSearchCriteria(
            typer = queryParams.typer.map { Type.of(it) },
            ytelser = queryParams.ytelser.map { Ytelse.of(it) },
            hjemler = queryParams.hjemler.map { Hjemmel.of(it) },
            navIdent = navIdent,
